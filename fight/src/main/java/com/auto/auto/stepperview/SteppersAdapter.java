    ...
    public void onBindViewHolder(final SteppersViewHolder holder, int p) {
        ...
        holder.buttonContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (config.getOnContinueAction() != null) {
                    config.getOnContinueAction().onContinue(position);
                }
            }
        });
        ...
        if (config.getOnCancelAction() != null)
            holder.buttonCancel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    config.getOnCancelAction().onCancel(position);
                }
            });
        ...
        if (beforeStep == position) {
            com.auto.auto.stepperview.AnimationUtils.hide(holder.linearLayoutContent);
        }
